...
function rubric (score) {
    ...
    if (score === 0) {
        ...
        result.href = "./assets/css/result2.css"; // applies result2 CSS to HTML - currently green
    } else if (score >= 10 && score <= 14) {
        depression_level = 'moderate depression'; // score 10-14: moderate depression
        result.href = "./assets/css/result3.css"; // applies result3 CSS to HTML - currently yellow
    } else if (score >= 15 && score <= 19) {
        depression_level = 'moderately severe depression'; // score 15-19: moderately severe depression
        result.href = "./assets/css/result4.css"; // applies result4 CSS to HTML - currently red
    } else if (score >= 20 && score <= 27) {
        depression_level = 'severe depression'; // score 20-27: severe depression
        result.href = "./assets/css/result5.css"; // applies result5 CSS to HTML - currently gray
    }
}
